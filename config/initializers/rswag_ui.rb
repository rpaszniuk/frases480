if Rails.env.development? || Rails.env.test?
  Rswag::Ui.configure do |c|
    ...
    c.swagger_endpoint '/api-docs/v1/swagger.yaml', 'API Docs'

    # Add Basic Auth in case your API is private
    # c.basic_auth_enabled = true
    # c.basic_auth_credentials Newfrases480::Application.credentials.rswag[:username], Newfrases480::Application.credentials.rswag[:password]
